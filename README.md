...
* Power switch on `S3`: KCD11 snap-in rocker planned (branch `case-kcd11-rocker`), SS12F15 slide switch in the case on `main`; see [BOM.md](BOM.md) for every off-board part (cell, switch, antenna, cables)
