...
| 8 | Printed: base + lid | Any opaque filament (PLA, PETG, ABS, ASA all work); lid text via colour change at Z 0.6 | 1 each | — | `case/stl/openrz67-base.stl`, `openrz67-lid.stl`. Locating pins Ø1.85 press lightly into the PCB holes. |
