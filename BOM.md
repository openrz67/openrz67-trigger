...
| 2 | Power switch | **KCD11** snap-in rocker, SPST, panel cutout 13.5 × 8.5 mm, two 2.8 mm tabs | 1 | `S3` via wire | Planned (branch `case-kcd11-rocker`, dims unverified). The case on `main` still fits the **SS12F15** slide switch with two screws; pick one before printing the lid. |
...
Status 2026-09-16: items 1, 4, 5–6 sourced or ordered; switch choice (item 2) open.
